...
const scheduleItems = [
  ...
  },
  {
    ...
    label: "Integracja",
    title: "Operacja Arka",
    desc: "Integracja na pełnej petardzie: szukanie swojej pary, wspólna wizja, bingo i rozmowy, po których lód znika szybciej niż na najlepszym letnim wyjeździe.",
  ...
  },
  {
    ...
    desc: "Foodtrucki, siatkówka, warsztaty i czas na wspólne bycie razem. Przestrzeń, żeby odpocząć i przeżyć ten dzień bez pośpiechu.",
    markerColor: "var(--festival-pink)",
    tagColor: "#F8C9DA",
    tagTextColor: "#A35378",
    tilt: -1,
